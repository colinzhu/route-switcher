...
public class RuleManageHandler {
    ...
    public Router getHandler() {
        ...
        router.route(HttpMethod.POST, "/api/rules").handler(this::updateOneRule);
        return router;
    }
    ...
    private void updateOneRule(RoutingContext routingContext) {
        ...
        ruleManager.getRules().put(jsonObject.getString("uriPrefix"), jsonObject.getString("target"));
